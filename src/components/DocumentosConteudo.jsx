...
export function ConteudoTermosDeUso() {
  return (
    <div className="space-y-6 leading-relaxed text-slate-800 dark:text-slate-200">
      <section>
...
export function ConteudoPoliticaPrivacidade() {
  return (
    <div className="space-y-6 leading-relaxed text-slate-800 dark:text-slate-200">
      <section>
